...
public class Inventories extends com.iridium.iridiumteams.configs.Inventories {
    ...
    public InventoryConfig islandMenu = new InventoryConfig(36, "&7Island Menu", background1, ImmutableMap.<String, Item>builder()
            .put("is home", new Item(XMaterial.WHITE_BED, 10, 1, "&9&lIsland Home", Collections.singletonList("&7Teleport to your island home")))
            .put("is members", new Item(XMaterial.PLAYER_HEAD, 12, "Peaches_MLG", 1, "&9&lIsland Members", Collections.singletonList("&7View your island members")))
            .put("is warps", new Item(XMaterial.END_PORTAL_FRAME, 14, 1, "&9&lIsland Warps", Collections.singletonList("&7View your island warps")))
            .put("is upgrades", new Item(XMaterial.DIAMOND, 16, 1, "&9&lIsland Upgrades", Collections.singletonList("&7View your island upgrades")))
            .put("is border", new Item(XMaterial.BEACON, 19, 1, "&9&lIsland Border", Collections.singletonList("&7Change your island border")))
            .put("is bank", new Item(XMaterial.PLAYER_HEAD, 21, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODM4MWM1MjlkNTJlMDNjZDc0YzNiZjM4YmI2YmEzZmRlMTMzN2FlOWJmNTAzMzJmYWE4ODllMGEyOGU4MDgxZiJ9fX0", 1, "&9&lIsland Bank", Collections.singletonList("&7View your island bank")))
            .put("is permissions", new Item(XMaterial.WRITABLE_BOOK, 23, 1, "&9&lIsland Permissions", Collections.singletonList("&7View your island permissions")))
            .put("is paliers", new Item(XMaterial.NETHER_STAR, 25, 1, "&9&lIsland Paliers", Collections.singletonList("&7View your island paliers")))
            .put("is delete", new Item(XMaterial.BARRIER, 35, 1, "&9&lDelete Island", Collections.singletonList("&7Delete your island")))
            .build()
    );
